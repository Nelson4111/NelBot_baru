const translations = {
  ...
  botqr:
    "*Pindai kode QR ini untuk menjadi Sub Bot*\n\n1. Klik tiga titik di kanan atas.\n2. Ketuk Tautan Terhubung\n3. Pindai kode QR ini",
  recon: "Koneksi terputus...",
  sesClose:
    "Koneksi ditutup, Anda harus terhubung secara manual dengan mengirimkan *ID*",
  ...
  connMsg:
    "Ketika Anda terhubung selanjutnya, kirim pesan berikut untuk masuk tanpa memindai kode QR lainnya",
  botlist: "Daftar Sub Bot Aktif",
  newcode: (usedPrefix) =>
    `Baik! Anda sekarang dapat menggunakan *${usedPrefix}jadibot* untuk meminta kode QR baru`,
  ...
  dev: "Pengembang",
  version: "Versi",
  searchTo: (value, usedPrefix, command) =>
    `Untuk mencari di ${value}:\n\n📌Gunakan: *${
      usedPrefix + command
  ...
  title: "Judul",
  noUsername: "Masukkan NSnama Pengguna",
  username: "NSnama Pengguna",
  followers: "Pengikut",
  follows: "Mengikuti",
  bio: "Biografi",
  posts: "Postingan",
  ...
  crimeAl:
    "Anda tidak terlalu berhati-hati saat masuk untuk mencuri dan mengaktifkan alarm. Anda hanya bisa membawa",
  ...
  toaud:
    "Balas video atau catatan suara yang ingin Anda konversi ke mp3 dengan perintah",
  ...
  delWarnUser:
    "Seorang admin mengurangi peringatan Anda, sekarang Anda memiliki",
  ...
  welMsg:
    "Masukkan Pesan Selamat Datang\n\n@user (mention)\n@group (NSnama grup)\n@desc (deskripsi grup)",
  leaMsg: "Masukkan Pesan Perpisahan\n\n@user (mention)",
  gpSetting: "Pengaturan grup\n\nBuka dan tutup grup",
  user: "Pengguna",
  userWarn: "Pengguna Diberi Peringatan",
  wningUser: (war) =>
    `Jika Anda menerima *${war}* peringatan, Anda akan otomatis dikeluarkan dari grup`,
  warnMaxU: (war) =>
    `Pengguna telah mencapai batas *${war}* peringatan dan akan dikeluarkan`,
  ...
  uptime: "Waktu Aktif",
  NSgc: (usedPrefix) =>
    `Grup ini tidak mengizinkan konten nsfw\nGunakan grup ini\n${NSgc}\n\nJika Anda adalah admin, aktifkan dengan\n*${usedPrefix}enable* nsfw`,
  nsfwAge:
    "Anda masih di bawah umur! Kembali ketika Anda berusia di atas 18 tahun",
  ...
  nameMax: "NSnama terlalu panjang",
  ...
  stickError:
    "Konversi gagal, coba kirim terlebih dahulu *gambar/video/gif* dan kemudian balas dengan perintah",
  ...
  premH:
    "Perintah ini hanya untuk anggota *Premium*\n\nKetik */premium* untuk info lebih lanjut",
